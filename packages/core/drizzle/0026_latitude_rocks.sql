...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "latitude"."document_logs" ADD CONSTRAINT "document_logs_apiKeyId_api_keys_id_fk" FOREIGN KEY ("apiKeyId") REFERENCES "latitude"."api_keys"("id") ON DELETE restrict ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
