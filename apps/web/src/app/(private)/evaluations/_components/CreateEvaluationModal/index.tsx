...
export default function CreateEvaluationModal({
  ...
  return (
    <ConfirmModal
      ...
      description='Creating a new evaluation enables you to analyze your logs and assign them a result, such as a score, a boolean value, or a category you define.'
